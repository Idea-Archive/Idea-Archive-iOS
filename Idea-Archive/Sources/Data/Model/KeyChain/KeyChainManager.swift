...
class KeychainManager {
    ...
    static func save(userId: String, refreshToken: Data) throws {
        let query: [String: AnyObject] = [
            kSecClass as String: kSecClassGenericPassword,
            kSecAttrAccount as String: userId as AnyObject,
            kSecValueData as String: refreshToken as AnyObject,
        ]
    ...
    static func get() -> (userId: String, refreshToken: String)? {
        let query: [String: AnyObject] = [
            kSecClass as String: kSecClassGenericPassword,
